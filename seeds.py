...
# insert users
db.add_all([
    User(username='derimarg', email='dg@email.com', password='password'),
    User(username='jwilloughway', email='jwill@email.com', password='password'),
    User(username='iboddam', email='idoddam@email.com', password='password'),
    User(username='satanmer', email='satan@email.com', password='password'),
    User(username='djiri', email='djiri@email.com', password='password')
])
